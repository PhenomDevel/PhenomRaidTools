...
L["You currently filter messages by %s, but haven't configured any name yet. Therefore all messages from all players will be displayed."] = "Du filterts aktuell alle Nachrichten nach %s aber hast noch keinen Namen spezifiziert. Daher werden alle Nachrichten empfangen und nicht gefiltert."
